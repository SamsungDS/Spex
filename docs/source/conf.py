...
extlinks = {
    ...
    "nix-install-windows": ("https://nixos.org/download.html#nix-install-windows%s", None),
    "nvme": ("https://nvmexpress.org/%s", None),
    "nvme-lint": ("https://github.com/linux-nvme/nvme-lint/%s", None),
    "nvme-lint-post": ("https://nvmexpress.org/nvme-lint-new-open-source-tool-to-help-validate-the-nvm-express-specifications/%s", None),
